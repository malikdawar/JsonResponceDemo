    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(MainActivity.this, ""+studentList.get(position).get(TAG_EMAIL), Toast.LENGTH_SHORT).show();

                Intent mIntent = new Intent(MainActivity.this, Details.class);
                mIntent.putExtra("email", studentList.get(position).get("email"));
